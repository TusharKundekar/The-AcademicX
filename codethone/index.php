...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 text-center text-lg-start">
                    <h1 class="display-4 fw-bold mb-4">The Future of Learning</h1>
                    <h5>"Welcome to our resource hub for BCA and BSc students! Access a vast collection of notes and previous year question papers to enhance your learning and exam preparation. Our goal is to provide quality study materials, making it easier
                        for you to succeed in your academic journey. Start exploring now!"
                    </h5>
                ...
                <div class="col-lg-6">
                    <img src="students.png" alt="Professional team illustration" class="hero-image">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card-custom card-degree">
                        <h3 class="mb-4">Degree</h3>
                        <p class="text-muted">BCA</p>
                        <p>All Semister Notes</p>
                        <button class="btn btn-custom">
                            <a class="nav-link" href="degree.html" role="button" aria-expanded="false">
                                Click here
                            </a>
                            </button>
                    </div>
                ...
                <!-- <div class="col-md-6">
                    <div class="card-custom card-competitions">
                        <h3 class="mb-4">PUC</h3>
                        <p>(Quiz, Art, Video Editing, Story & Photography)</p>
                        <button class="btn btn-custom">Click here</button>
                    </div>
                </div> -->
                <div class="col-md-4">
                    <div class="card-custom card-qp">
                        <h3 class="mb-4">Question Papers</h3>
                        <p>BCA</p>
                        <p>Previous Year's Question Pappers</p>
                        <button class="btn btn-custom"><a class="nav-link" href="both.html" role="button" aria-expanded="false">
                            Click here
                        </a></button>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card-custom card-resume">
                        <h3 class="mb-4">Resume</h3>
                        <p>(ATS Professional Resumes For Reference)</p>
                        <button class="btn btn-custom">Click here</button>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <h3>ABOUT US</h3>
                    <p>Whether you're a student preparing for exams, an educator seeking teaching aids, or simply someone passionate about learning, Our Creative Info is here to support you. Explore our resources today and embark on a path to success!
                        <a href="#" class="click-more">Click More.</a>
                    </p>
                </div>
